...
public class GraphApp extends Application {
    ...
    public void start(Stage ignored) {
        ...
        scene.getStylesheets().addAll(this.getClass().getResource("/graphapplication/styles/style.css").toExternalForm());

        Stage stage = new Stage(StageStyle.DECORATED);
        stage.setTitle("Aplicação Didática sobre Grafos - Época Recurso – Variante B");
        stage.getIcons().add(new Image("/graphapplication/styles/favicon.png"));
